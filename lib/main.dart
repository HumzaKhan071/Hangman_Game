...
import 'package:hangman_game/ui/utils/game.dart';
import 'package:hangman_game/ui/widget/figure_image.dart';
import 'package:hangman_game/ui/widget/letter.dart';
...
class _HomeAppState extends State<HomeApp> {
  // chossing the game word
  String word = "Flutter".toUpperCase();

  // Create a List that contains all the Alphabet,or you can just copy and paste
